  ...
  try:
    script = '''
      ...
      VALUES 
          ...
          ('Christopher Jones', 'christopher.jones@example.com', '+1234567895', 'London', ?),
          ...
          ('Sarah White', 'sarah.white@example.com', '+1234567804', 'London', ?),
          ('Daniel Harris', 'daniel.harris@example.com', '+1234567805', 'Cambridge', ?),
          ('Nancy Clark', 'nancy.clark@example.com', '+1234567806', 'Southampton', ?),
          ('Karen Lewis', 'karen.lewis@example.com', '+1234567807', 'London', ?),
          ...
          ('David Wilson', 'david.wilson@example.com', '+1234567811', 'London', ?),
          ('Margaret Taylor', 'margaret.taylor@example.com', '+1234567812', 'Manchester', ?),
          ('James Brown', 'james.brown@example.com', '+1234567813', 'Birmingham', ?),
          ('Susan Evans', 'susan.evans@example.com', '+1234567814', 'Leeds', ?),
          ('Robert Thompson', 'robert.thompson@example.com', '+1234567815', 'Manchester', ?),
          ('Patricia Garcia', 'patricia.garcia@example.com', '+1234567816', 'Liverpool', ?),
          ('William Martinez', 'william.martinez@example.com', '+1234567817', 'Leeds', ?),
          ('Jennifer Lee', 'jennifer.lee@example.com', '+1234567818', 'Edinburgh', ?),
          ('John Wright', 'john.wright@example.com', '+1234567819', 'Sheffield', ?),
          ('Helen Scott', 'helen.scott@example.com', '+1234567820', 'Manchester', ?),
          ('Charles Harris', 'charles.harris@example.com', '+1234567821', 'Cardiff', ?),
          ('Margaret Clark', 'margaret.clark@example.com', '+1234567822', 'Belfast', ?),
          ('Richard Turner', 'richard.turner@example.com', '+1234567823', 'Dublin', ?),
          ('Elizabeth Murphy', 'elizabeth.murphy@example.com', '+1234567824', 'Aberdeen', ?),
          ('David Walker', 'david.walker@example.com', '+1234567825', 'Cambridge', ?),
          ('Barbara Hill', 'barbara.hill@example.com', '+1234567826', 'Oxford', ?),
          ('Michael King', 'michael.king@example.com', '+1234567827', 'Edinburgh', ?),
          ('Susan Green', 'susan.green@example.com', '+1234567828', 'Brighton', ?),
          ('Joseph Wright', 'joseph.wright@example.com', '+1234567829', 'Nottingham', ?),
          ('Karen Phillips', 'karen.phillips@example.com', '+1234567830', 'Southampton', ?);
